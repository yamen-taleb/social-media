...
<template>
    <div class="py-3 px-2 border rounded-md bg-white shadow-sm mb-3">
        <div
            class="w-full p-3 text-gray-500 rounded-lg border border-gray-300 min-h-[44px] bg-white hover:bg-gray-50 cursor-pointer hover:border-indigo-500 hover:ring-2 hover:ring-indigo-200 transition-all duration-200 resize-none"
            @click="createPost"
        >
            What's on your mind?
        </div>
