...
const showImagePreview = computed(() => avatarImage.value || props.avatar || 'https://cdn.iconscout.com/icon/free/png-256/free-avatar-370-456322.png?f=webp');
...
<template>
    <div
        class="relative ml-[48px] w-[128px] h-[128px] -mt-[64px] cursor-pointer"
    ...
    >
        ...
        <!-- Overlay -->
        <div
            class="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-50 rounded-full transition-all duration-300 opacity-0 hover:opacity-100"
        >
        </div>
        <div
            class="relative shadow-md p-2 bg-white rounded-md mt-3 text-gray-600 hover:text-gray-700"
        ...
        >
            ...
            >
                <button
                    class="mx-auto text-red-500 hover:text-red-600"
