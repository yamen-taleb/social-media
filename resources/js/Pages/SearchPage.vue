...
<template>
  <AuthenticatedLayout>
    <div class="mx-auto mt-4 w-1/2 space-y-4">
      <!-- Users Section -->
      <div v-if="usersList.data.length > 0" class="rounded-md bg-white px-4 py-3 shadow-sm">
        <h2 class="mb-2 text-lg font-semibold">People</h2>
      ...
      <!-- Groups Section -->
      <div v-if="groupsList.data.length > 0" class="rounded-md bg-white px-4 py-3 shadow-sm">
        ...
        <div class="mt-1 flex justify-center">
          <button
            ...
            class="rounded-md px-2 text-sm text-blue-600 hover:bg-blue-100 hover:text-blue-800 disabled:opacity-50"
          >
